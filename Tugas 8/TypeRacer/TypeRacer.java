...
public class TypeRacer {
    ...
    private String[] wordsToTypeList = {
            "Hidup kadang begini kadang begitu, tapi sudah mau bagaimana lagi, harus kutelan semua walau pahit",
            "Tutorial bunuh orang tanpa diketahui oleh polisi",
            "Katakanlah katakan sejujurnya, apa mungkin kita bersatu, kalau tak mungkin lagi kita bercerita tentang cinta, untuk apa aku dan kamu bersatu",
            "Foto yang tak berani dilirik mata, kontak sekarang jadi sebatas nama",
            "Maybe we seek something for something that we couldnt ever have, maybe we choose the only love we know we wont accept"
    };
